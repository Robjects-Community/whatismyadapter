...
// Determine root directory (works both locally and in container)
$rootDir = file_exists('/var/www/html/vendor/autoload.php') 
    ? '/var/www/html'  // Container path
    : dirname(__DIR__, 2);  // Local path
...
if (!file_exists($bootstrap)) {
    echo "Error: Cannot find bootstrap.php at $bootstrap\n";
    exit(1);
}

// Set environment for proper bootstrapping
define('ROOT', $rootDir);
define('APP_DIR', 'src');
