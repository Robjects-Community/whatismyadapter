# Create API Controller for JSON responses
...
# Save API controller
with open('ApiQuizController.php', 'w') as f:
    f.write(api_controller)

print("✅ API Quiz Controller created!")
print("📄 File: ApiQuizController.php")
print("🔧 Features:")
print("   • RESTful JSON API endpoints")
print("   • Quiz session management")
print("   • Real-time question flow")
print("   • Product search and details")
