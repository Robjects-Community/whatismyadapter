# Create CakePHP Models for the quiz system
...
# Save model files
with open('Product.php', 'w') as f:
    f.write(product_entity)

with open('ProductsTable.php', 'w') as f:
    f.write(product_table)

print("✅ CakePHP Models created!")
print("📄 Files: Product.php, ProductsTable.php")
print("🔧 Features:")
print("   • Entity with filtering and scoring methods")
print("   • Table with AI matching algorithm")
print("   • Custom finders for quiz criteria")
print("   • Explanation generation system")