...
return [
    ...
    'Email' => [
        'default' => [
            'transport' => env('EMAIL_DEFAULT_TRANSPORT', 'gmail'),
            'from' => [env('EMAIL_FROM_ADDRESS', 'mike.mail.tester@gmail.com') => env('EMAIL_FROM_NAME', 'WillowCMS')],
            /*
    ...
    'Queue' => [
        'default' => [
            'url' => 'redis://root:root@127.0.0.1:6379/0',
            'queue' => 'default',
            'logger' => 'stdout',
