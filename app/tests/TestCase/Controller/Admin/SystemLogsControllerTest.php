...
/**
 * App\Controller\Admin\SystemLogsController Test Case
 *
 * Auto-generated test file for Admin SystemLogsController
 * Tests admin authentication and authorization requirements
 *
 * @uses \App\Controller\Admin\SystemLogsController
 */
class SystemLogsControllerTest extends AdminControllerTestCase
{
    ...
    {
        $this->mockAdminUser();
        $this->get('/admin/system-logs/view');
    ...
    {
        $this->mockAdminUser();
        $this->get('/admin/system-logs/delete');
    ...
    {
        $this->loginAsAdmin();
        $this->get('/admin/system-logs/add');
    ...
    public function testViewRouteExists(): void
    {
        ...
        $tableName = strtolower('SystemLogs');
        $id = $this->getFirstFixtureId($tableName);
        
        if ($id) {
            $this->get("/admin/system-logs/view/{$id}");
            $statusCode = $this->_response->getStatusCode();
