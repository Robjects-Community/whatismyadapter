 ...
 *
 * Auto-generated test file for Admin ArticlesController
 * Tests admin authentication and authorization requirements
 *
 * @uses \App\Controller\Admin\ArticlesController
 */
class ArticlesControllerTest extends AdminControllerTestCase
{
    ...
    /**
     * Test treeIndex method - Admin authenticated access
     *
     * @return void
     */
    public function testTreeIndexAsAdmin(): void
    {
        $this->mockAdminUser();
        $this->get('/admin/articles/tree-index');
    ...
    /**
     * Test treeIndex method - Requires admin authentication
     *
     * @return void
     */
    public function testTreeIndexRequiresAdmin(): void
    {
    ...
    /**
     * Test updateTree method - Admin authenticated access
     *
     * @return void
     */
    public function testUpdateTreeAsAdmin(): void
    {
        $this->mockAdminUser();
        $this->enableCsrf();
        $this->post('/admin/articles/update-tree');
    ...
    /**
     * Test updateTree method - Requires admin authentication
     *
     * @return void
     */
    public function testUpdateTreeRequiresAdmin(): void
    {
        $this->mockUnauthenticatedRequest();
        $this->post('/admin/articles/update-tree');
    ...
    {
        $this->mockAdminUser();
        $this->get('/admin/articles/view/12bc5d51-9b2e-42be-9ac8-e0837ab885e1');
    ...
    {
        $this->mockAdminUser();
        $this->get('/admin/articles/edit/12bc5d51-9b2e-42be-9ac8-e0837ab885e1');
    ...
    public function testDeleteAsAdmin(): void
    {
        $this->mockAdminUser();
        $this->enableCsrf();
        $this->post('/admin/articles/delete/12bc5d51-9b2e-42be-9ac8-e0837ab885e1');
    ...
    /**
     * Test bulkAction method - Admin authenticated access
     *
     * @return void
     */
    public function testBulkActionAsAdmin(): void
    {
        $this->mockAdminUser();
        $this->enableCsrf();
        $this->post('/admin/articles/bulk-action');
    ...
    /**
     * Test bulkAction method - Requires admin authentication
     *
     * @return void
     */
    public function testBulkActionRequiresAdmin(): void
    {
        $this->mockUnauthenticatedRequest();
        $this->post('/admin/articles/bulk-action');
    ...
    public function testViewRouteExists(): void
    {
        ...
        $tableName = strtolower('Articles');
        $id = $this->getFirstFixtureId($tableName);
        
        if ($id) {
            $this->get("/admin/articles/view/{$id}");
            $statusCode = $this->_response->getStatusCode();
