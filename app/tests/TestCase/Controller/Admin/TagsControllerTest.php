 ...
 *
 * Auto-generated test file for Admin TagsController
 * Tests admin authentication and authorization requirements
 *
 * @uses \App\Controller\Admin\TagsController
 */
class TagsControllerTest extends AdminControllerTestCase
{
    ...
    {
        $this->mockAdminUser();
        $this->get('/admin/tags/tree-index');
    ...
    public function testUpdateTreeAsAdmin(): void
    {
        $this->mockAdminUser();
        $this->enableCsrf();
        $this->post('/admin/tagss/update-tree');
    ...
    public function testDeleteAsAdmin(): void
    {
        $this->mockAdminUser();
        $this->enableCsrf();
        $this->post('/admin/tagss/delete/1');
    ...
    public function testViewRouteExists(): void
    {
        ...
        $tableName = strtolower('Tags');
        $id = $this->getFirstFixtureId($tableName);
        
        if ($id) {
            $this->get("/admin/tags/view/{$id}");
            $statusCode = $this->_response->getStatusCode();
