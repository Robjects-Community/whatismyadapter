...
/**
 * App\Controller\Admin\AipromptsController Test Case
 *
 * Auto-generated test file for Admin AipromptsController
 * Tests admin authentication and authorization requirements
 *
 * @uses \App\Controller\Admin\AipromptsController
 */
class AipromptsControllerTest extends AdminControllerTestCase
{
    ...
    {
        $this->mockAdminUser();
        $this->get('/admin/aiprompts/view/1');
    ...
    {
        $this->mockAdminUser();
        $this->get('/admin/aiprompts/edit/1');
    ...
    public function testDeleteAsAdmin(): void
    {
        $this->mockAdminUser();
        $this->enableCsrf();
        $this->post('/admin/aipromptss/delete/1');
    ...
    public function testViewRouteExists(): void
    {
        ...
        $tableName = strtolower('Aiprompts');
        $id = $this->getFirstFixtureId($tableName);
        
        if ($id) {
            $this->get("/admin/aiprompts/view/{$id}");
            $statusCode = $this->_response->getStatusCode();
