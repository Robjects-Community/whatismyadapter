 ...
 *
 * Auto-generated test file for ImageGalleriesImagesController
...
class ImageGalleriesImagesControllerTest extends TestCase
{
    ...
    public function testIndexAuthenticated(): void
    {
        ...
        $this->get('/image-galleries-images');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/image-galleries-images/view');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/image-galleries-images/add');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/image-galleries-images/edit');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/image-galleries-images/delete');
