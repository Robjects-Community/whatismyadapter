...
/**
 * App\Controller\InternationalisationsController Test Case
 *
 * Auto-generated test file for InternationalisationsController
 * Tests both authenticated and unauthenticated access scenarios
 *
 * @uses \App\Controller\InternationalisationsController
 */
class InternationalisationsControllerTest extends TestCase
{
    ...
    public function testIndexAuthenticated(): void
    {
        ...
        $this->get('/internationalisations');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/internationalisations/view');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/internationalisations/add');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/internationalisations/edit');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/internationalisations/delete');
