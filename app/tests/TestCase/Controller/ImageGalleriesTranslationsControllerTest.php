...
/**
 * App\Controller\ImageGalleriesTranslationsController Test Case
 *
 * Auto-generated test file for ImageGalleriesTranslationsController
 * Tests both authenticated and unauthenticated access scenarios
 *
 * @uses \App\Controller\ImageGalleriesTranslationsController
 */
class ImageGalleriesTranslationsControllerTest extends TestCase
{
    ...
    public function testIndexAuthenticated(): void
    {
        ...
        $this->get('/image-galleries-translations');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/image-galleries-translations/view');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/image-galleries-translations/add');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/image-galleries-translations/edit');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/image-galleries-translations/delete');
