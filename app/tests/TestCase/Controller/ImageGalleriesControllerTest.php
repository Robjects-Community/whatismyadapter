 ...
 *
 * Auto-generated test file for ImageGalleriesController
...
class ImageGalleriesControllerTest extends TestCase
{
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/image-galleries/delete');
