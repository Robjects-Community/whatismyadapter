 ...
 *
 * Auto-generated test file for TagsTranslationsController
...
class TagsTranslationsControllerTest extends TestCase
{
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/tags-translations/view');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/tags-translations/add');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/tags-translations/edit');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/tags-translations/delete');
