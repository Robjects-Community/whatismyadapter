 ...
 *
 * Auto-generated test file for EmailTemplatesController
...
class EmailTemplatesControllerTest extends TestCase
{
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/email-templates/delete');
