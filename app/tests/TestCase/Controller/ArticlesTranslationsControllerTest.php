...
/**
 * App\Controller\ArticlesTranslationsController Test Case
 *
 * Auto-generated test file for ArticlesTranslationsController
 * Tests both authenticated and unauthenticated access scenarios
 *
 * @uses \App\Controller\ArticlesTranslationsController
 */
class ArticlesTranslationsControllerTest extends TestCase
{
    ...
    public function testIndexAuthenticated(): void
    {
        ...
        $this->get('/articles-translations');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/articles-translations/view');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/articles-translations/add');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/articles-translations/edit');
    ...
    {
        $this->mockAuthenticatedUser();
        $this->get('/articles-translations/delete');
