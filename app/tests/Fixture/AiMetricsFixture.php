...
class AiMetricsFixture extends TestFixture
{
    ...
    public array $fields = [
        ...
        'tokens_used' => ['type' => 'integer', 'null' => true],
        'cost_usd' => ['type' => 'decimal', 'length' => 10, 'precision' => 6, 'null' => true],
        'success' => ['type' => 'boolean', 'default' => true, 'null' => false],
        'error_message' => ['type' => 'text', 'null' => true],
        'model_used' => ['type' => 'string', 'length' => 50, 'null' => true],
        ...
        '_indexes' => [
            ...
            'success_idx' => ['type' => 'index', 'columns' => ['success']],
        ],
    ];
